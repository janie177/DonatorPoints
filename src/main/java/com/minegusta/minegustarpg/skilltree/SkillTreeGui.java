...
public class SkillTreeGui {
    ...
    public static List<ItemStack> getmenuItems(String uuid) {
        ...
        items.add(addItemMeta(Branches.WARRIOR.getItemStack(), Lists.newArrayList(ChatColor.GOLD + "Next rank: " + ChatColor.YELLOW + "+10% melee damage.", ChatColor.GOLD + "Current rank: " + ChatColor.YELLOW + "+" + SkillTreeData.getWarriorFromFile(uuid) * 10 + "% melee damage.", ChatColor.GREEN + "" + SkillTreeData.getWarriorFromFile(uuid) + ChatColor.DARK_PURPLE + "/" + ChatColor.YELLOW + "5" + ChatColor.YELLOW + " unlocked.")));
        items.add(addItemMeta(Branches.ARCHER.getItemStack(), Lists.newArrayList(ChatColor.GOLD + "Next rank: " + ChatColor.YELLOW + "+15% bow damage.", ChatColor.GOLD + "Current rank: " + ChatColor.YELLOW + "+" + SkillTreeData.getArcherFromFile(uuid) * 15 + "% bow damage.", ChatColor.GREEN + "" + SkillTreeData.getArcherFromFile(uuid) + ChatColor.DARK_PURPLE + "/" + ChatColor.YELLOW + "3" + ChatColor.YELLOW + " unlocked.")));
        items.add(addItemMeta(Branches.POWER.getItemStack(), Lists.newArrayList(ChatColor.GOLD + "Next rank: " + ChatColor.YELLOW + "+10% chance for sword knockback.", ChatColor.GOLD + "Current rank: " + "+" + ChatColor.YELLOW + SkillTreeData.getPowerFromFile(uuid) * 10 + "% chance for sword knockback.", ChatColor.GREEN + "" + SkillTreeData.getPowerFromFile(uuid) + ChatColor.YELLOW + "/" + ChatColor.DARK_GREEN + "3" + ChatColor.YELLOW + " unlocked.")));
        items.add(addItemMeta(Branches.ATHLETE.getItemStack(), Lists.newArrayList(ChatColor.GOLD + "Next rank: " + ChatColor.YELLOW + "-15% fall damage.", ChatColor.GOLD + "Current rank: " + ChatColor.YELLOW + "-" + SkillTreeData.getAthleteFromFile(uuid) * 15 + "% fall damage.", ChatColor.GREEN + "" + SkillTreeData.getAthleteFromFile(uuid) + ChatColor.YELLOW + "/" + ChatColor.DARK_GREEN + "5" + ChatColor.YELLOW + " unlocked.")));
        ...
        items.add(addItemMeta(Branches.BOWMAN.getItemStack(), Lists.newArrayList(ChatColor.GOLD + "Next rank: " + ChatColor.YELLOW + "+8% chance to shoot two arrows at once.", ChatColor.GOLD + "Current rank: " + ChatColor.YELLOW + SkillTreeData.getBowManFromFile(uuid) * 8 + "% chance to shoot two arrows at once.", ChatColor.GREEN + "" + SkillTreeData.getBowManFromFile(uuid) + ChatColor.YELLOW + "/" + ChatColor.DARK_GREEN + "3" + ChatColor.YELLOW + " unlocked.")));
        ...
        items.add(addItemMeta(Branches.TANK.getItemStack(), Lists.newArrayList(ChatColor.GOLD + "Next rank: " + ChatColor.YELLOW + "Take -10% combat damage.", ChatColor.GOLD + "Current rank: " + ChatColor.YELLOW + "-" + SkillTreeData.getTankFromFile(uuid) * 10 + "% combat damage.", ChatColor.GREEN + "" + SkillTreeData.getTankFromFile(uuid) + ChatColor.YELLOW + "/" + ChatColor.DARK_GREEN + "5" + ChatColor.YELLOW + " unlocked.")));
        ...
        items.add(addItemMeta(Branches.HEALER.getItemStack(), Lists.newArrayList(ChatColor.GOLD + "Next rank: " + ChatColor.YELLOW + "Heal everyone around you +2.5 hearts and yourself +1 heart every 3 minutes. ", ChatColor.GOLD + "Current rank: " + ChatColor.YELLOW + "Heal everyone around you for " + SkillTreeData.getHealerFromFile(uuid) * 2.5 + " hearts and yourself for " + SkillTreeData.getHealerFromFile(uuid) + " hearts every 3 minutes.", ChatColor.GREEN + "" + SkillTreeData.getHealerFromFile(uuid) + ChatColor.YELLOW + "/" + ChatColor.DARK_GREEN + "4" + ChatColor.YELLOW + " unlocked.")));
        ...
        items.add(addItemMeta(Branches.ALCHEMIST.getItemStack(), Lists.newArrayList(ChatColor.GOLD + "Next rank: " + ChatColor.YELLOW + "+10% chance for splash potions to multiply on throwing.", ChatColor.GOLD + "Current rank: " + ChatColor.YELLOW + SkillTreeData.getAlchemistFromFile(uuid) * 10 + "% chance for splash potions to multiply on throwing.", ChatColor.GREEN + "" + SkillTreeData.getAlchemistFromFile(uuid) + ChatColor.YELLOW + "/" + ChatColor.DARK_GREEN + "4" + ChatColor.YELLOW + " unlocked.")));

        items.add(addItemMeta(Branches.LUCK.getItemStack(), Lists.newArrayList(ChatColor.GOLD + "Next rank: " + ChatColor.YELLOW + "+15% chance for monster drops.", ChatColor.GOLD + "Current rank: +" + ChatColor.YELLOW + "+" + SkillTreeData.getLuckFromFile(uuid) * 15 + "% chance for monster drops.", ChatColor.GREEN + "" + SkillTreeData.getLuckFromFile(uuid) + ChatColor.YELLOW + "/" + ChatColor.DARK_GREEN + "3" + ChatColor.YELLOW + " unlocked.")));
