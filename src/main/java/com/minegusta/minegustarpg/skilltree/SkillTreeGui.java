...
public class SkillTreeGui {
    ...
    public static List<ItemStack> getmenuItems(String uuid) {
        ...
        items.add(addItemMeta(Branches.WARRIOR.getItemStack(), Lists.newArrayList(ChatColor.GOLD + "Next rank: " + ChatColor.YELLOW + "+4 melee damage.", ChatColor.GOLD + "Current rank: " + ChatColor.YELLOW + "+" + SkillTreeData.getWarriorFromFile(uuid) * 4 + " melee damage.", ChatColor.GREEN + "" + SkillTreeData.getWarriorFromFile(uuid) + ChatColor.YELLOW + "/" + ChatColor.DARK_GREEN + "5" + ChatColor.YELLOW + " unlocked.")));
        items.add(addItemMeta(Branches.ARCHER.getItemStack(), Lists.newArrayList(ChatColor.GOLD + "Next rank: " + ChatColor.YELLOW + "+4 bow damage.", ChatColor.GOLD + "Current rank: " + ChatColor.YELLOW + "+" + SkillTreeData.getArcherFromFile(uuid) * 4 + " bow damage.", ChatColor.GREEN + "" + SkillTreeData.getArcherFromFile(uuid) + ChatColor.YELLOW + "/" + ChatColor.DARK_GREEN + "5" + ChatColor.YELLOW + " unlocked.")));
        ...
        items.add(addItemMeta(Branches.HEALER.getItemStack(), Lists.newArrayList(ChatColor.GOLD + "Next rank: " + ChatColor.YELLOW + "Heal everyone around you for 25% every 90 seconds. ", ChatColor.GOLD + "Current rank: " + ChatColor.YELLOW + "Heal everyone around you for " + SkillTreeData.getHealerFromFile(uuid) * 25 + "% hearts every 90 seconds.", ChatColor.GREEN + "" + SkillTreeData.getHealerFromFile(uuid) + ChatColor.YELLOW + "/" + ChatColor.DARK_GREEN + "4" + ChatColor.YELLOW + " unlocked.", ChatColor.YELLOW + "Activate by crouch + right-click.")));
