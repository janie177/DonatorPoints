...
public class SkillTreeGui {
    ...
    public static List<ItemStack> getmenuItems(String uuid) {
        ...
        items.add(addItemMeta(Branches.HEALER.getItemStack(), Lists.newArrayList(ChatColor.GOLD + "Next rank: " + ChatColor.YELLOW + "Heal everyone around you +2.5 hearts every 3 minutes. ", ChatColor.GOLD + "Current rank: " + ChatColor.YELLOW + "Heal everyone around you for " + SkillTreeData.getHealerFromFile(uuid) * 2.5 + " hearts every 3 minutes.", ChatColor.GREEN + "" + SkillTreeData.getHealerFromFile(uuid) + ChatColor.YELLOW + "/" + ChatColor.DARK_GREEN + "4" + ChatColor.YELLOW + " unlocked.")));
