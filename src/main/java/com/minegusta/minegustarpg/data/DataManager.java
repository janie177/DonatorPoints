package com.minegusta.minegustarpg.data;
...
import com.minegusta.minegustarpg.npc.DefaultNPC;
...
public class DataManager {
    ...
    public static int startSaveTask() {
        return Bukkit.getScheduler().scheduleAsyncRepeatingTask(MinegustaRPGPlugin.PLUGIN, new Runnable() {
            @Override
            public void run() {
                save();
  ...
  */
    ...
    public static class PointsSave extends ConfigFile3<String, Integer> {
        ...
        public String getSavePath() {
            return MinegustaRPGPlugin.SAVE_PATH;
        }
